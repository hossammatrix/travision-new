 ...
 * 👇 Main component
 */
const MealTree = ({ originalData, treeCategories }) => {
    const tableSettings = {};
    ...
    const tableColumns = useMemo(() => {
        return [
            ...
            { field: "category_path", headerName: "Category", width: 300 },
        ];
    }, []);

    // flatten
    const tableRows = useMemo(() => {
        return originalData?.flatMap((item) => item.children || []) || [];
    }, [originalData]);
    ...
    const settings = {
        ...
        treeName: "Meals",
        title: "Meals tree",
        addChildTitle: "Add Meal",
        addGroupTitle: "Add Meal Group",
        editChildTitle: "Edit Meal",
        editGroupTitle: "Edit Meal Group",
    };
